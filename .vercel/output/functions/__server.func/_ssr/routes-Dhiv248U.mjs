...
import { a as Printer, i as Search, o as List, r as Shield, t as X } from "../_libs/lucide-react.mjs";
import { n as clsx, t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { t as Slot } from "../_libs/radix-ui__react-slot.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-Dhiv248U.js
...
var META = {
	...
	subtitle: "A synthesis of core security concepts, control taxonomies, risk, and zero-trust architecture",
	objectives: [{
		id: "1.1",
...
var SECTIONS = [
	{
		...
		keywords: "executive summary takeaways cia ciana aaa risk zero trust controls",
		blocks: [
			{
				t: "lead",
	...
	},
	{
		...
		keywords: "information security systèmes d'information data systems computers servers",
		blocks: [
			{
				t: "p",
	...
	},
	{
		...
		keywords: "cia triad ciana pentagon triple a confidentiality integrity availability non-repudiation authentication authorization accounting",
		blocks: [
			{
				t: "p",
			...
			{
				t: "ul",
				items: ["**Non-repudiation** — an action or event cannot later be denied by the parties involved. Canonical method: digital signatures.", "**Authentication** — the claimed identity of a user or system is verified before trust is extended."]
			},
			{
				t: "p",
	...
	},
	{
		...
		keywords: "confidentiality encryption access control data masking physical security training privacy compliance",
		blocks: [
			{
				t: "lead",
	...
	},
	{
		...
		keywords: "integrity hashing digital signatures checksums access controls audits accuracy trust",
		blocks: [
			{
				t: "lead",
	...
	},
	{
		...
		keywords: "availability redundancy servers data network power continuity reputation",
		blocks: [
			{
				t: "lead",
	...
	},
	{
		...
		keywords: "non-repudiation digital signatures hash digest private key asymmetric authenticity accountability",
		blocks: [
			{
				t: "lead",
			...
			{
				t: "ol",
				items: ["The message is hashed to produce a digest — a fixed-size string of letters and numbers.", "That digest is encrypted with the user’s private key using asymmetric cryptography."]
			},
			{
				t: "p",
	...
	},
	{
		...
		keywords: "authentication mfa knowledge possession inherence action location factors",
		blocks: [
			{
				t: "lead",
	...
	},
	{
		...
		keywords: "authorization permissions privileges least privilege sensitive data integrity ux",
		blocks: [
			{
				t: "lead",
	...
	},
	{
		...
		keywords: "accounting audit trail syslog siem network analysis forensics compliance accountability",
		blocks: [
			{
				t: "lead",
	...
	},
	{
		...
		keywords: "threat vulnerability risk natural disaster cyberattack bugs patches physical security",
		blocks: [
			{
				t: "lead",
	...
	},
	{
		...
		keywords: "technical managerial administrative operational physical categories contrôles",
		blocks: [
			{
				t: "p",
	...
	},
	{
		...
		keywords: "preventive deterrent detective corrective compensating directive types prévention dissuasion",
		blocks: [
			{
				t: "p",
			...
			{
				t: "table",
				caption: "Illustrative pairings — not an exhaustive catalog. Each cell is a different control, not a synonym.",
				headers: [
					"Type \\ Category",
					"Technical",
					"Managerial",
	...
	},
	{
		...
		keywords: "gap analysis écarts poam plan of action milestones technical business cloud",
		blocks: [
			{
				t: "lead",
	...
	},
	{
		...
		keywords: "zero trust zéro confiance control plane data plane adaptive identity pep policy engine",
		blocks: [
			{
				t: "lead",
	...
	},
	{
		...
		keywords: "conclusions implications program design synthesis judgment",
		blocks: [
			{
				t: "p",
...
function Panel({ className, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: cn("rounded-lg border border-rule bg-paper-2/60 p-3 sm:p-4", className),
		children
	});
}
function Label({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		className: "font-sans text-xs font-medium tracking-wide text-accent",
		children
	});
}
function Body({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		className: "mt-1 font-sans text-sm leading-snug text-muted",
		children
	});
}
function Diagram({ name }) {
	switch (name) {
		case "cia": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
			className: "my-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "grid gap-3 sm:grid-cols-3",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Confidentiality" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Body, { children: "Only authorized parties can read. Method: encryption." })] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Integrity" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Body, { children: "Data stay accurate unless authorized change. Method: checksums." })] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Availability" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Body, { children: "Reachable when needed. Method: redundancy." })] })
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("figcaption", {
				className: "mt-3 font-sans text-xs tracking-wide text-subtle",
				children: "Figure 1. CIA triad — three properties of information."
			})]
		});
		case "ciana": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
			className: "my-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					["N", "Non-repudiation"],
					["A", "Authentication"]
				].map(([letter, title]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				className: "mt-3 font-sans text-xs tracking-wide text-subtle",
				children: "Figure 2. CIANA pentagon — CIA plus proof of act and proof of identity."
			})]
		});
		case "aaa": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
			className: "my-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
				...
				].map(([n, title, body]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-sans text-xs tabular-nums tracking-widest text-subtle",
						children: n
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: title }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Body, { children: body })
				] }) }, title))
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("figcaption", {
				className: "mt-3 font-sans text-xs tracking-wide text-subtle",
				children: "Figure 3. AAA — the access lifecycle. Sequence, not a parallel set."
			})]
		});
		case "risk": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
			className: "my-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "grid gap-3 sm:grid-cols-3",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Threat" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Body, { children: "A potential cause of harm — flood, attacker, disclosure, integrity event." })] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
						className: "border-accent/30 bg-accent/5",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Risk" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Body, { children: "Exists only at the intersection. Either side alone is not risk." })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Vulnerability" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Body, { children: "An internal weakness — bug, misconfig, missing patch, open door." })] })
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("figcaption", {
				className: "mt-3 font-sans text-xs tracking-wide text-subtle",
				children: "Figure 4. Risk as intersection. Manage it by moving either side, or both."
			})]
		});
		case "factors": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
			className: "my-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					[
						"Where",
						"Location",
						"A place that must be true."
					]
				].map(([k, title, body]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-sans text-xs tracking-widest text-subtle uppercase",
						children: k
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: title }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Body, { children: body })
				...
				className: "mt-3 font-sans text-xs tracking-wide text-subtle",
				children: "Figure 5. Five authentication factor families. MFA combines unlike families."
			})]
		});
		case "categories": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
			className: "my-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				].map(([title, body]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: title }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Body, { children: body })] }, title))
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("figcaption", {
				className: "mt-3 font-sans text-xs tracking-wide text-subtle",
				children: "Figure 6. Four control categories — the substance of the control."
			})]
		});
		case "types": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
			className: "my-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				className: "mt-3 font-sans text-xs tracking-wide text-subtle",
				children: "Figure 7. Six control types — the function of the control."
			})]
		});
		case "gap": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
			className: "my-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
				...
				children: [
					...
					[
						"3",
						"Analyze",
						"Mark where it falls short."
					],
					[
						"4",
						"Plan",
						"Write the closing steps."
					]
				].map(([n, title, body]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-sans text-xs tabular-nums tracking-widest text-subtle",
				...
				className: "mt-3 font-sans text-xs tracking-wide text-subtle",
				children: "Figure 8. Gap analysis, then POA&M — diagnosis, then dated treatment."
			})]
		});
		case "zerotrust": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
			className: "my-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "grid gap-3 md:grid-cols-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Control plane" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
					className: "mt-2 space-y-1.5 font-sans text-sm text-muted",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Adaptive identity" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Threat-scope reduction" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Policy-driven access control" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Secured zones" })
					]
				})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Data plane" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
					className: "mt-2 space-y-1.5 font-sans text-sm text-muted",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Subject / system" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Policy engine" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Policy administrator" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Policy enforcement point" })
					]
				})] })]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("figcaption", {
				className: "mt-3 font-sans text-xs tracking-wide text-subtle",
				children: "Figure 9. Zero trust as two planes — course mapping. Default deny, then verify."
			})]
		});
		case "redundancy": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
			className: "my-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				className: "mt-3 font-sans text-xs tracking-wide text-subtle",
				children: "Figure 10. Four redundancy types that underwrite availability."
			})]
		});
		default: return null;
	}
...
function Rich({ text }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: parts.map((part, i) => part.startsWith("**") && part.endsWith("**") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
...
function BlockView({ block }) {
	switch (block.t) {
		case "lead": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "font-serif text-xl leading-snug text-fg sm:text-2xl",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rich, { text: block.text })
		});
		case "p": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rich, { text: block.text }) });
		case "h3": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
			className: "mt-10 font-serif text-xl font-medium tracking-tight text-fg first:mt-0",
			children: block.text
		});
		case "h4": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
			className: "mt-8 font-sans text-sm font-medium tracking-wide text-accent",
			children: block.text
		});
		case "ul": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
			className: "my-4 list-disc space-y-2 pl-5 marker:text-steel",
			children: block.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rich, { text: item }) }, item))
		});
		case "ol": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
			className: "my-4 list-decimal space-y-2 pl-5 marker:font-sans marker:text-sm marker:text-steel",
			children: block.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rich, { text: item }) }, item))
		});
		case "callout": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
			className: "my-8 border-l-2 border-accent pl-4 sm:pl-5",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "font-sans text-xs font-medium tracking-widest text-accent uppercase",
		...
		case "quote": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("blockquote", {
			className: "my-8 font-serif text-xl leading-snug text-fg italic sm:text-2xl",
			children: block.text
		});
		case "defs": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dl", {
			className: "my-6 divide-y divide-rule border-y border-rule",
			children: block.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
					className: "font-sans text-sm font-medium text-fg sm:col-span-1",
					children: item.term
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dd", {
					className: "text-muted sm:col-span-2",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rich, { text: item.def })
				})]
			}, item.term))
		});
		case "grid": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: block.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rich, { text: item.body })
				})]
			}, item.title))
		});
		case "table": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					...
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: block.rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", {
						className: "odd:bg-paper even:bg-paper-2/40",
						children: row.map((cell, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							className: cn("border-b border-rule px-3 py-2.5 text-muted", i === 0 && "font-medium text-fg"),
							children: cell
						}, `${row[0]}-${i}`))
					}, row[0])) })]
				})
		...
		case "diagram": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Diagram, { name: block.name });
		case "takeaways": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
			className: "my-8 space-y-4",
			children: block.items.map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
				className: "flex gap-4",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "font-sans text-xs tabular-nums tracking-widest text-subtle pt-1.5",
					children: String(i + 1).padStart(2, "0")
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-fg",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rich, { text: item })
				})]
			}, item))
		});
		default: return null;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				className: "border-b border-rule pb-10",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						className: "mt-4 font-serif text-4xl leading-none tracking-tight text-fg sm:text-5xl",
						children: META.title
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-4 max-w-2xl font-serif text-lg leading-snug text-muted sm:text-xl",
						children: META.subtitle
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dl", {
						className: "mt-8 grid gap-4 font-sans text-sm sm:grid-cols-3",
						children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: META.objectives.map((obj) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "rounded-md border border-rule px-4 py-3",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "font-sans text-xs tracking-widest text-subtle uppercase",
								children: ["Objective ", obj.id]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			SECTIONS.map((section) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "font-sans text-xs font-medium tracking-widest text-subtle uppercase",
						children: [section.num, section.kicker ? ` · ${section.kicker}` : null]
					}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-6 space-y-5 font-serif text-base leading-relaxed text-fg sm:text-lg",
						children: section.blocks.map((block, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BlockView, { block }, `${section.id}-${i}`))
					})
				]
			}, section.id)),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
				className: "mt-4 border-t border-rule pt-8 font-sans text-xs leading-relaxed text-subtle",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "This briefing synthesizes Section 2 source notes (mixed French/English course material). OCR artifacts in the source — for example “Unedisponibilité,” “Uneuthentication,” “Uneuthorisation,” “Uncomptage” — are read as availability, authentication, authorization, and accounting. Control-plane / data-plane membership follows the source’s first, consistent statement of zero trust." })
			})
		]
	});
}
var buttonVariants = cva("inline-flex items-center justify-center gap-2 rounded-md font-sans font-medium transition-[color,background-color,transform,opacity] duration-150 ease-out focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-steel disabled:pointer-events-none disabled:opacity-40 active:not-disabled:scale-[0.96]", {
	variants: {
		variant: {
			default: "bg-paper text-ink hover:bg-paper-2",
			ghost: "text-paper/80 hover:bg-ghost hover:text-paper",
			outline: "border border-hairline bg-transparent text-paper hover:bg-ghost",
			paper: "border border-rule bg-paper text-fg hover:bg-paper-2",
...
function BriefingReader() {
	...
	const filtered = (0, import_react.useMemo)(() => {
		...
		return SECTIONS.filter((s) => {
			return `${s.title} ${s.kicker ?? ""} ${s.keywords}`.toLowerCase().includes(q);
		});
	}, [query]);
	(0, import_react.useEffect)(() => {
		const nodes = Array.from(document.querySelectorAll("article section[id]"));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
				className: "no-print sticky top-0 z-40 border-b border-hairline bg-ink/92 backdrop-blur-md",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mx-auto flex h-14 max-w-7xl items-center gap-3 px-4 sm:px-6",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "flex size-8 items-center justify-center rounded-md bg-ghost text-paper",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "truncate font-sans text-sm font-medium tracking-wide",
								children: "Security Fundamentals"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "hidden truncate font-sans text-xs text-paper/55 sm:block",
								children: [
									"Brief ",
									META.briefNo,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-4",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("aside", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "px-2 font-sans text-xs tracking-widest text-paper/40 uppercase",
								children: "Contents"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
								className: "mt-3 space-y-0.5",
								children: filtered.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									type: "button",
									onClick: () => jump(s.id),
									className: cn("flex w-full items-baseline gap-3 rounded-md px-2 py-2 text-left font-sans text-sm transition-colors duration-150", activeId === s.id ? "bg-ghost text-paper" : "text-paper/55 hover:bg-ghost hover:text-paper"),
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "w-6 shrink-0 text-xs tabular-nums text-paper/35",
										children: s.num
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							query && filtered.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-4 px-2 font-sans text-sm text-paper/45",
					...
					id: "brief",
					className: "px-3 py-6 sm:px-6 sm:py-10 lg:col-span-3 lg:pr-8",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "print-paper rounded-xl bg-paper p-5 text-fg shadow-paper sm:rounded-2xl sm:p-10 lg:p-14",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DocumentArticle, {})
					})
				})]
			}),
			tocOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					className: "absolute inset-y-0 left-0 flex w-80 max-w-full flex-col bg-ink-2 shadow-paper",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "border-b border-hairline p-3",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "relative",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, {
									className: "pointer-events-none absolute top-1/2 left-3 size-3.5 -translate-y-1/2 text-paper/40",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
							...
							children: filtered.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								type: "button",
								onClick: () => jump(s.id),
								className: cn("flex min-h-11 w-full items-center gap-3 rounded-md px-2 py-2 text-left font-sans text-sm", activeId === s.id ? "bg-ghost text-paper" : "text-paper/70"),
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "w-6 text-xs tabular-nums text-paper/35",
									children: s.num
								}), s.title]
							}) }, s.id))
						})
...
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BriefingReader, {});
}
//#endregion
